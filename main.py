...
class Pipe:
    def __init__(self):
        ...
        # Position
        self.top_pipe_x, self.bottom_pipe_x = 700, 700
    ...
    def update(self):
        self.top_pipe_x -= 1
        self.bottom_pipe_x -= 1

    def draw(self, win):
        win.blit(self.top_pipe, (self.top_pipe_x, self.top_pipe_y))
        win.blit(self.bottom_pipe, (self.bottom_pipe_x, self.bottom_pipe_y))
